...
```bash
composer require mediacentr/laravel-wizard
```
...
use MediaCentr\LaravelWizard\Facades\Wizard;
...
use MediaCentr\LaravelWizard\Step;
...
The CSS for this package default view is based on the [Bootstrap Steps](https://github.com/mediacentr/bootstrap-steps), use NPM installation to use:
...
[ico-version]: https://img.shields.io/packagist/v/mediacentr/laravel-wizard?style=flat-square
...
[link-downloads]: https://packagist.org/packages/mediacentr/laravel-wizard
