...
use MediaCentr\LaravelWizard\Contracts\StepRepository as StepRepositoryContract;
...
class StepRepository implements StepRepositoryContract
{
     ...
     * Create a new steps.
     *
     * @param  \MediaCentr\LaravelWizard\Wizard  $wizard
     * @param  mixed  $steps
     */
     ...
     *
     * @param  int  $key
     * @return \MediaCentr\LaravelWizard\Step|null
     */
     ...
     *
     * @param  array|\MediaCentr\LaravelWizard\Step|string  $stepClass
     ...
     *
     * @param  \MediaCentr\LaravelWizard\Step|null  $step
     * @return \MediaCentr\LaravelWizard\Step|null $step
     */
    public function current($step = null)
    {
        if ($step instanceof \MediaCentr\LaravelWizard\Step) {
