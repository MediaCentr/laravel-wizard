...
namespace MediaCentr\LaravelWizard;

use Closure;
use Illuminate\Http\Request;
use MediaCentr\LaravelWizard\Exceptions\StepNotFoundException;
...
trait Wizardable
{
     ...
     *
     * @param  \Illuminate\Http\Request  $request
     * @param  \MediaCentr\LaravelWizard\Step  $step
     ...
     * @return \MediaCentr\LaravelWizard\Step
     *
     * @throws \MediaCentr\LaravelWizard\Exceptions\StepNotFoundException
     */
    protected function getWizardStep(Request $request, string $slug = null)
    {
        /** @var \MediaCentr\LaravelWizard\Step|null $step */
        if (isset($slug)) {
    ...
    {
        /** @var \MediaCentr\LaravelWizard\Step $step */
     ...
     *
     * @return \MediaCentr\LaravelWizard\Wizard
     */
    protected function wizard()
    {
        if (! $this->wizard) {
            /** @var \MediaCentr\LaravelWizard\WizardFactory $factory */
     ...
     *
     * Available options reference from MediaCentr\LaravelWizard\Wizard::$optionsKeys.
     *
     * @return array
     */
