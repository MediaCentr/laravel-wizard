...
namespace MediaCentr\LaravelWizard\Cache;

use Illuminate\Contracts\Auth\Guard;
use Illuminate\Contracts\Container\Container;
use Illuminate\Database\ConnectionInterface;
use Illuminate\Support\Arr;
use MediaCentr\LaravelWizard\Contracts\CacheStore;
...
class DatabaseStore implements CacheStore
{
     ...
     *
     * @var \MediaCentr\LaravelWizard\Cache\CachedFileSerializer
     */
     ...
     * @param  string  $table
     * @param  \MediaCentr\LaravelWizard\Cache\CachedFileSerializer  $serializer
